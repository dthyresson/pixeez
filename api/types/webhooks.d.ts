...
import type { OnBackgroundRemovedInput, OnThumbnailCreatedInput, OnTagsCreatedInput, Mutation } from "./shared-schema-types";
...
/** SDL: onThumbnailCreated(input: OnThumbnailCreatedInput!): Pic! */
export interface OnThumbnailCreatedResolver {
    (args: {input: OnThumbnailCreatedInput}, obj: { root: Mutation, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): Promise<RTPic>;
}
