...
const PicsForm = ({ onSubmit, loading, error }) => {
  ...
  return (
    <Form
      ...
      error={error}
      className="mx-auto mt-8 max-w-2xl rounded-lg bg-white p-6 shadow-md dark:bg-gray-800"
    >
      <div className="mb-4">
        <Label
          name="albumId"
        ...
        <SelectField
          name="albumId"
          className="w-full rounded-lg border px-3 py-2 text-gray-700 focus:border-blue-500 focus:outline-none dark:bg-gray-800 dark:text-white"
